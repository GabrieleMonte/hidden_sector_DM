...
analytic formulas in `hidden_sector_DM/model.py`.

## Notebooks

| Notebook | Process | Model | DM spin |
|----------|---------|-------|---------|
| `XX_YY_hP_and_vP_v2.nb` | X X → Y Y (2→2 annihilation) | Higgs Portal (Majorana X, scalar Y) + Vector Portal (Dirac X, vector Y) | both |
| `YXX_XX_vP_v2.nb` | Y X X → X X (3→2 cannibal) | Vector Portal | Dirac |
| `YXX_XX_hP_v2.nb` | Y X X → X X (3→2 cannibal) | Higgs Portal | Majorana |
| `YYX_YX_vP_v2.nb` | Y Y X → Y X (3→2 cannibal) | Vector Portal | Dirac |
| `YYX_YX_hP_v2.nb` | Y Y X → Y X (3→2 cannibal) | Higgs Portal | Majorana |
...
|-----------|---------|-----------|
| `MsqTerms_YXX_XX_vP_v2/` | Y X X → X X (Vector Portal) | 8 |
| `MsqTerms_YXX_XX_hP_v2/` | Y X X → X X (Higgs Portal) | 16 |
| `MsqTerms_YYX_YX_vP_v2/` | Y Y X → Y X (Vector Portal) | 6 |
| `MsqTerms_YYX_YX_hP_v2/` | Y Y X → Y X (Higgs Portal) | 6 |
